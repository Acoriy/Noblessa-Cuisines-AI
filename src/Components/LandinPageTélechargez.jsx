    ...
    <div className="flex flex-col ">
      ...
      <form className="flex flex-col gap-[20px] p-5 justify-center  mx-auto">
        ...
        <div className="flex flex-col gap-[12px] md:gap-[14px]">
          <span className="font-light text-[10px] leading-[10px] md:text-[12px] md:leading-[20px] ">* champs obligatoires</span>
          ...
          <button className="mx-auto w-[130px] h-[40px] text-[12px]   text-[#fff] rounded-full bg-Primary hover:bg-HoverColor  transition-transform duration-300 ease-in-out">TÉLÉCHARGER</button>
        </div>
      </form>
...
export default LandinPageTélechargez;
